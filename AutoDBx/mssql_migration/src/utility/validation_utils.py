...
class Validation:
    def __init__(self, spark, config_catalog, config_schema, config_table, validation_catalog, validation_schema, validation_table, host, port, user_name, password, src, jdbc_driver):
        self.spark = spark
