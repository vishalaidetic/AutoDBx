...
class Validation:
    def __init__(self, spark, config_catalog, config_schema, config_table, validation_catalog, validation_schema, validation_table, project, parentProject, credentials_base64, src):
        self.spark = spark
    ...
    def read_data(self, source_schema, source_table):
        """
    ...
    def validate_tables(self, target_table, source_table):
        """
        ...
        try:
            source_catalog, source_schema, source_table_name = source_table.split(".")
            source_schema = source_catalog+"."+source_schema
            source_df = self.read_data(source_schema, source_table_name)
    ...
    def main(self):
        ...
        for row in config_df.collect():
            ...
            self.validate_tables(target_table, source_table)
